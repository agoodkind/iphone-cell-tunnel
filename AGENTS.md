...
- **Commands:** `make help` lists engine targets from swift-makefile, then appends CellTunnelDev's own help via `help::`. Named Make targets (`build-mac`, `relay-up`, ...) are thin routers into that tool. Start there.
