...
- **Commands:** `make help` lists engine targets from swift-makefile, then appends CellTunnelDev's own help via `help::`. Named Make targets (`build-mac`, `relay-up`, ...) route into that tool. Start there.
