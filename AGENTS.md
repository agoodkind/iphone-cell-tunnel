...
- **Commands:** `make help` lists every build, lint, test, format, and install target with a one-line description. Engine targets come from swift-makefile; project targets append under `help::` in the Makefile. Start there.
